...
export const TEAMS: { key: string; name: string; short: string; icon: LucideIcon; color: string; systems: string[] }[] = [
  ...
  { key: 'mech', name: '설비팀', short: '설비', icon: Wrench, color: '#2563eb', systems: ['공조', '냉난방수', '환기', '급수', '급탕', '배수', '가스', 'Domestic Cold Water', 'Domestic Hot Water', 'Sanitary', 'Hydronic Supply', 'Hydronic Return', 'Vent', 'Supply Air', 'Return Air', 'Exhaust Air'] },   // 영문은 실무 IFC의 Pset 유도 계통(레빗 System Classification)
