...
export const IFC_KO: Record<string, string> = {
  ...
  IfcUnitaryEquipment: '공조기·FCU·실외기', IfcAirTerminal: '디퓨저', IfcAirTerminalBox: '가변풍량(VAV)', IfcDuctSegment: '덕트', IfcDuctFitting: '덕트 이음', IfcDamper: '댐퍼', IfcFan: '팬', IfcAirToAirHeatRecovery: '전열교환기', IfcChiller: '냉동기', IfcCoolingTower: '냉각탑', IfcBoiler: '보일러', IfcHeatExchanger: '열교환기', IfcHumidifier: '가습기', IfcCoil: '코일',
